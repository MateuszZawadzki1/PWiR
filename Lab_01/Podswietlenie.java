...
public class Podswietlenie extends JLabel implements Runnable {
    ...
    public Podswietlenie(String text, String kierunek, int szybkosc) {
        this.text = text;
    ...
    public static void main(String[] args) {
        ...
        RolowanyTekst etykieta = new RolowanyTekst(" \nT\ne\nk\ns\nt\n w\n p\nr\na\nw\no\n ".repeat(10), "prawo", 100);
